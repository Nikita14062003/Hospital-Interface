...
con=sqlcon.connect(host="127.0.0.1",user="root",password="")#connection to mysql 
cur=con.cursor()
...
def register():
    ...
    label=Label(root1,text="REGISTER",font='arial 25 bold')
    label.pack()
    ...
    e5.place(x=120,y=290)
    l6=Label(root1,text="BLOOD GROUP")
    l6.place(x=10,y=330)
    e6=tkinter.Entry(root1)
    e6.place(x=120,y=330)
    b1=Button(root1,text="SUBMIT",command=lambda:[entry(),root1.destroy()])
...
def apo_details():
    ...
    if int(p1)==1:
        ...
        cur.execute(query)
        tkinter.messagebox.showinfo("APPOINTMENT DETAILS",f"Your appointment is fixed with {det[0]}\nDate= {det[1]} \nTime= {det[2]} \nAppointment no.= {det[3]}")
...
def get_apoint():
    ...
    if len(a)==0:
        ...
        if i[3]=='M' or i[3]=='m':
                x="Mr."
                name2=Label(root3,text=i[1],font='arial 10 bold')
                name2.place(x=160,y=80)
        else:
                x="Mrs\Ms."
                name2=Label(root3,text=i[1],font='arial 10 bold')
                name2.place(x=190,y=80)
        for i in dat:
            name=Label(root3,text='WELCOME',font='arial 10 bold')
            name.place(x=50,y=80)
            name1=Label(root3,text=x,font='arial 10 bold')
            name1.place(x=130,y=80)
            age=Label(root3,text='AGE:-',font='arial 10 bold')
            age.place(x=50,y=100)
            age1=Label(root3,text=i[2],font='arial 10 bold')
            age1.place(x=90,y=100)
            phone=Label(root3,text='PHONE:-',font='arial 10 bold')
            phone.place(x=50,y=120)
            phone1=Label(root3,text=i[4],font='arial 10 bold')
            phone1.place(x=110,y=120)
            bg=Label(root3,text='BLOOD GROUP:-',font='arial 10 bold')
            bg.place(x=50,y=140)
            bg1=Label(root3,text=i[5],font='arial 10 bold')
            bg1.place(x=160,y=140)


        L=Label(root3,text='DEPARTMENTS',font='arial 10 bold')
        L.place(x=50,y=220)
        ...
        x2.place(x=150,y=400)
        
        L7=Label(root3,text=('Enter date')).place(x=50,y=430)
        x3=tkinter.Entry(root3)
        x3.place(x=150,y=430)

        L8=Label(root3,text=('Enter time')).place(x=50,y=460)
        x4=tkinter.Entry(root3)
        x4.place(x=150,y=460)
...
def apoint():
    ...
    b1=Button(root2,text='Submit',command=lambda:[get_apoint(),root2.destroy()])
...
def lst_doc():
    ...
    l1=Label(root4,text='NAME',font='arial 10 bold') 
    l1.place(x=20,y=10)
    count=20
    for i in l:
       count=count+20
    ...
    l2=Label(root4,text='DEPARTMENT',font='arial 10 bold')
    l2.place(x=140,y=10)
    count1=20
    for i in m:
       count1=count1+20
    ...
    l4=Label(root4,text='ROOM NO.',font='arial 10 bold')
    l4.place(x=300,y=10)
    count2=20
    for i in n:
       count2=count2+20
       l5=Label(root4,text=i)
       l5.place(x=300,y=count2)
...
def ser_avail():
    ...
    l1=Label(root5,text='SERVICES AVAILABLE',font='arial 10 bold')
    l1.place(x=20,y=10)
    ...
    l2=Label(root5,text='ROOM NO.',font='arial 10 bold')
    l2.place(x=200,y=10)
    g=[1,2,3,4,5,6,7,8,9]
    count2=20
    for i in g:
    ...
    l5=Label(root5,text='To avail any of these services, call on our toll free no.:- 1101',font='arial 10 normal')
    l5.place(x=20,y=240)
...
def mod_sub():
    ...
    ad=x3.get()
    b1=Button(root7,text='Submit',command=lambda:[modify(),root7.destroy()])
    b1.place(x=100,y=160)
...
def search_data():
    ...
    frame.pack()
    l1=Label(root8,text="AADHAAR NO.")
    l1.place(x=10,y=130)
    x3=tkinter.Entry(root8)
    x3.place(x=100,y=130)
    ad=x3.get()
    b1=Button(root8,text='Submit',command=lambda:[view_data(),root8.destroy()])
    b1.place(x=100,y=160)
...
def view_data():
    ...
    if len(a)==0:
        ...
        tkinter.messagebox.showinfo("APPOINTMENT DETAILS",f"Aadhar no.= {a[0][0]},\nName= {a[0][1]}, \nAge= {a[0][2]}, \nGender= {a[0][3]}, \nPhone no.= {a[0][4]}, \nBlood group= {a[0][5]}")
        
        
   
root=Tk()
root.geometry("1100x1000")
label=Label(root,text="GOODWILL HOSPITAL",font="arial 40 bold",bg='light green')
...
b3=Button(text="Doctors",font="arial 20 bold",bg='yellow',command=lst_doc)
b4=Button(text="Services",font='arial 20 bold',bg='yellow',command=ser_avail)
b7=Button(text="View data",font='arial 20 bold',bg='yellow',command=search_data)
b5=Button(text="Modify data",font='arial 20 bold',bg='yellow',command=mod_sub)
